...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Distillery> result = distilleryRepository.findDistilleriesForRegion("Lowland");
        List<Distillery> result1 = distilleryRepository.findDistilleriesWith12YearOldWhisky();
        List<Whisky> result2 = whiskyRepository.findWhiskiesForRegion("Highland");
        List<Whisky> result3 = whiskyRepository.findWhiskiesForYear(2018);
        List<Whisky> result4 = whiskyRepository.findWhiskyFromDistilleryOfASpecificAge(distillery1,12);
