...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Pirate> results = shipRepository.findAllPiratesForShip(pearl);

        List<Pirate> mTMResults = raidRepository.getPiratesForRaid(raid2);

        List<Pirate> overAgeResult = pirateRepository.getPiratesOverGivenAge(54);
