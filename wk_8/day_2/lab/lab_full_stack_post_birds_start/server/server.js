...
MongoClient.connect('mongodb://localhost:27017')
  .then((client) => {
    ...
    const sightingsRouter = createRouter(sightingsCollection);//function on create_router - holds server side instruction on what to do when it see a .get/.post etc request.  initial request written in request.js in helpers.
